...
CLEARANCE_PROB=0.0
TRANSITION_RATE_NOT_IMMUNE={TRANSITION_RATE_NOT_IMMUNE} # switching rate. every 6 days
...
IRS_ON=False
IRS_START_TIMES=[] # A vector with start times for the IRS interventions. Each element is the starting time of an IR,29160]
